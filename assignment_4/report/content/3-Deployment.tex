...
\paragraph{3.}
After that, the application is available via \url{http://localhost:8080/parliament/}. \Fig{fig:subsubsec:03_depl_list} shows the list page, and \Fig{fig:subsubsec:03_depl_detail} shows the detail page of one parliament member using Firefox.
